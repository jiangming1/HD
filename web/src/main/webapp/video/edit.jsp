<%@ page language="java" import="java.util.*,shan.HDHealthManagement.po.Video" pageEncoding="utf-8"%>
<%
...
<body>
	...
	%>
	<input type="text" name="id" style="display:none;" value="<%=video.getId() %>">
	<div class="layui-form-item">
			<label class="layui-form-label">名称</label>
			<div class="layui-input-block">
				<input type="text" name="name" value="<%=video.getName() %>" placeholder="请输入" lay-verify="required"
		...
		<div class="layui-form-item">
			<img src="<%=basePath %><%=video.getFile() %>">
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
