...
<body>
	<div id="top">
		...
		<div id="top_links">
			<div id="top_op">
				<ul>
					<li><img src="<%=basePath%>/images/common/user.jpg">： <span>admin</span></li>
					<li><img alt="今天是" src="<%=basePath%>/images/common/date.jpg">：<span id="day_day"></span></li>
				</ul>
			</div>
			<div id="top_close">
				<a href="javascript:void(0);" onclick="logout();" target="_parent">
					<img src="<%=basePath%>/images/common/close.jpg"
