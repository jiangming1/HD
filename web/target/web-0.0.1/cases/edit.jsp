<%@ page language="java" import="java.util.*,shan.HDHealthManagement.po.Cases" pageEncoding="utf-8"%>
<%
...
<body>
	...
	%>
	<input type="text" name="id" style="display:none;" value="<%=cases.getId() %>">
	<div class="layui-form-item">
			<label class="layui-form-label">案例</label>
			<div class="layui-input-block">
				<input type="text" name="caseName" value="<%=cases.getCaseName() %>" placeholder="请输入" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="name" value="<%=cases.getName() %>" placeholder="请输入" lay-verify="required"
					autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="doctor" value="<%=cases.getDoctor() %>" placeholder="请输入" lay-verify="required"
					autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="hospital" value="<%=cases.getHospital() %>" placeholder="请输入" lay-verify="required"
					autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
